...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('custom_provider', (
        ...
        db.send_create_signal('custom', ['Provider'])


    def backwards(self, orm):
        
        # Deleting model 'Provider'
        db.delete_table('custom_provider')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 45, 13, 986658)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 45, 13, 990502)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
