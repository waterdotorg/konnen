...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationSubscription.water_quality_notification_email_daily_semaphore'
        db.add_column('custom_locationsubscription', 'water_quality_notification_email_daily_semaphore', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LocationSubscription.water_quality_notification_email_weekly_semaphore'
        db.add_column('custom_locationsubscription', 'water_quality_notification_email_weekly_semaphore', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LocationSubscription.water_quality_notification_email_daily_semaphore'
        db.delete_column('custom_locationsubscription', 'water_quality_notification_email_daily_semaphore')

        # Deleting field 'LocationSubscription.water_quality_notification_email_weekly_semaphore'
        db.delete_column('custom_locationsubscription', 'water_quality_notification_email_weekly_semaphore')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 11, 11, 3, 667062)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 11, 11, 3, 673049)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
        ...
        'custom.locationsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_email_daily_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_email_weekly_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['custom.Location']"}),
        ...
        'custom.locationsubscriptionnotificationlog': {
            'Meta': {'object_name': 'LocationSubscriptionNotificationLog'},
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_subscription': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['custom.LocationSubscription']"}),
            'notification_type': ('django.db.models.fields.SmallIntegerField', [], {}),
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
