...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Provider.mobile_shorthand_code'
        db.add_column('custom_provider', 'mobile_shorthand_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Provider.mobile_shorthand_code'
        db.delete_column('custom_provider', 'mobile_shorthand_code')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 22, 15, 52, 34, 767217)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 22, 15, 52, 34, 772160)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
