...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocationPostReporterRemarks'
        db.create_table('custom_locationpostreporterremarks', (
        ...
        db.send_create_signal('custom', ['LocationPostReporterRemarks'])


    def backwards(self, orm):
        
        # Deleting model 'LocationPostReporterRemarks'
        db.delete_table('custom_locationpostreporterremarks')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 22, 16, 11, 51, 212583)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 22, 16, 11, 51, 218792)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
