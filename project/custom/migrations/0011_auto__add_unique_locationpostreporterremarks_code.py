...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'LocationPostReporterRemarks', fields ['code']
        db.create_unique('custom_locationpostreporterremarks', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LocationPostReporterRemarks', fields ['code']
        db.delete_unique('custom_locationpostreporterremarks', ['code'])
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 10, 49, 17, 139482)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 10, 49, 17, 143830)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
