...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('custom_community', (
        ...
        db.send_create_signal('custom', ['Community'])

        # Adding field 'Location.community'
        db.add_column('custom_location', 'community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom.Community'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Community'
        db.delete_table('custom_community')

        # Deleting field 'Location.community'
        db.delete_column('custom_location', 'community_id')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 14, 51, 42, 462333)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 14, 51, 42, 465970)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
