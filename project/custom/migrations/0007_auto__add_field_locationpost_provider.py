...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationPost.provider'
        db.add_column('custom_locationpost', 'provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom.Provider'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LocationPost.provider'
        db.delete_column('custom_locationpost', 'provider_id')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 10, 49, 43, 624768)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 10, 49, 43, 628976)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
