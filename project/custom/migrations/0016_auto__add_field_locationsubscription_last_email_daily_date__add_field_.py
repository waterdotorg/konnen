...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationSubscription.last_email_daily_date'
        db.add_column('custom_locationsubscription', 'last_email_daily_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'LocationSubscription.last_email_weekly_date'
        db.add_column('custom_locationsubscription', 'last_email_weekly_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LocationSubscription.last_email_daily_date'
        db.delete_column('custom_locationsubscription', 'last_email_daily_date')

        # Deleting field 'LocationSubscription.last_email_weekly_date'
        db.delete_column('custom_locationsubscription', 'last_email_weekly_date')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 10, 18, 14, 553347)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 10, 18, 14, 558214)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
