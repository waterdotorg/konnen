...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WaterSourceType'
        db.create_table('custom_watersourcetype', (
        ...
        db.send_create_signal('custom', ['WaterSourceType'])

        # Adding field 'LocationPost.water_source_type'
        db.add_column('custom_locationpost', 'water_source_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom.WaterSourceType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'WaterSourceType'
        db.delete_table('custom_watersourcetype')

        # Deleting field 'LocationPost.water_source_type'
        db.delete_column('custom_locationpost', 'water_source_type_id')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 14, 33, 10, 848213)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 14, 33, 10, 851396)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
