...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationPost.type'
        db.add_column('custom_locationpost', 'type', self.gf('django.db.models.fields.CharField')(default='water_quality', max_length=100), keep_default=False)

        # Adding field 'LocationPost.chlorine_level'
        db.add_column('custom_locationpost', 'chlorine_level', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LocationPost.type'
        db.delete_column('custom_locationpost', 'type')

        # Deleting field 'LocationPost.chlorine_level'
        db.delete_column('custom_locationpost', 'chlorine_level')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 10, 12, 58, 461978)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 10, 12, 58, 464749)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
