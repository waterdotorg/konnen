...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocationSubscriptionNotificationLog'
        db.create_table('custom_locationsubscriptionnotificationlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('location_subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom.LocationSubscription'])),
        ...
        db.send_create_signal('custom', ['LocationSubscriptionNotificationLog'])


    def backwards(self, orm):
        
        # Deleting model 'LocationSubscriptionNotificationLog'
        db.delete_table('custom_locationsubscriptionnotificationlog')
    ...
    models = {
        ...
        'custom.location': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 15, 15, 1, 257213)'}),
        ...
        'custom.locationpost': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 15, 15, 1, 262072)'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
